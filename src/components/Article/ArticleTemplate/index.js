...
const ArticleTemplate = () => {
    return(
        <Container>
            <Typography variant="h3" dangerouslySetInnerHTML={{__html: `<h1>Hello World! 👋</h1>`}}></Typography>
...
"Il n'y a personne qui aime la souffrance pour elle-même, qui ne la recherche et qui ne la veuille pour elle-même..."</Typography>
